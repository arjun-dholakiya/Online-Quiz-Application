...
/**
 * ViewAllQuiz class displays all quizzes in the database to the admin
 * with their quiz ID, title, and number of questions.
 */
public class ViewAllQuiz extends JFrame implements ActionListener {
    ...
    ViewAllQuiz() {
        ...
        // Page title
        JLabel pageTitle = new JLabel("All Quizzes");
        pageTitle.setFont(new Font("Tahoma", Font.BOLD, 20));
        pageTitle.setBounds(280, 10, 250, 30);
        add(pageTitle);
